...
<ul style="text-align: justify; margin-top: 0.5em; margin-bottom: 1.5em; padding-left: 1.5em;">
  <li style="margin-bottom: 0.8em;">
    <strong>Implementación Integral de la Solución:</strong> Se logró desarrollar e integrar exitosamente una arquitectura compuesta por un frontend en Vue y un backend en C# con .NET, permitiendo la comunicación entre ambas capas mediante servicios REST y garantizando el funcionamiento integral de la plataforma.
  </li>
  <li style="margin-bottom: 0.8em;">
  ...
  <li style="margin-bottom: 0.8em;">
    <strong>Persistencia y Gestión de Datos:</strong> La implementación de una base de datos relacional mediante Entity Framework Core permitió garantizar la persistencia y gestión consistente de la información del sistema.
  </li>
  <li style="margin-bottom: 0.8em;">
