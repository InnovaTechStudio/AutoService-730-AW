    ...
    <tbody>
      <tr>
        ...
        <td valign="top">
          ...
          <br><br>
          <b>Mamani Vilca, Alan Jaivi</b> AV1: Sustenté la arquitectura de software en el modelado del diagrama de clases y el modelo de base de datos, adaptando el lenguaje técnico para asegurar la comprensión del sistema. Además, conduje entrevistas a administradores de taller, demostrando escucha activa para extraer necesidades clave y validar supuestos del Lean UX.<br><br>TB1: Participé en el diseño y modelado de la arquitectura lógica del sistema mediante la elaboración del modelo de datos y los diagramas de clases UML. Asimismo, colaboré activamente con los integrantes encargados del frontend y backend para asegurar que las entidades, relaciones y estructuras definidas respondieran a los requerimientos funcionales identificados durante la etapa de análisis. También brindé soporte en la revisión de historias de usuario y en la validación de los flujos de negocio relacionados con la gestión de clientes, vehículos y órdenes de trabajo.<br><br>AV2: Asumí un rol activo en el diseño de la arquitectura backend basada en Domain-Driven Design (DDD), participando en la definición de bounded contexts, agregados, entidades y relaciones del dominio. Elaboré diagramas de clases, diagramas entidad-relación y modelos de persistencia que sirvieron como guía para la implementación de los Web Services. Además, participé en las entrevistas de validación con administradores de talleres automotrices, recopilando retroalimentación para verificar la alineación de los flujos implementados con las necesidades reales de los usuarios y apoyando la documentación técnica del Sprint 3.<br><br>
