    ...
    <tbody>
      <tr>
        ...
        <td valign="top">
          ...
          TB1: Se demostró liderazgo colaborativo participando en el desarrollo del sistema de seguimiento vehicular y apoyando la integración de componentes del proyecto. Además, se resolvieron conflictos técnicos y se mantuvo una comunicación constante con el equipo, permitiendo una correcta coordinación de tareas y un avance estable durante el desarrollo del sistema.<br><br>
      ...
      <tr>
        ...
        <td valign="top">
          ...
          TB1: Se fortaleció el trabajo en equipo mediante la implementación de la interfaz de seguimiento del cliente y la organización estructurada del código. Asimismo, se brindó apoyo continuo en la coordinación técnica y documentación del proyecto, facilitando la comprensión del sistema y contribuyendo al cumplimiento de los objetivos dentro del tiempo establecido.<br><br>
         ...
         <b>Sanchez Cuadrado, Juan Antonio</b> AV1: Demostré liderazgo compartido y compromiso colaborativo al contribuir en la definición estratégica de AutoService, fortaleciendo la comprensión del problema, la propuesta de valor y el enfoque Lean UX del proyecto. Asimismo, participé activamente en la organización de contenidos, la planificación visual de la presentación y la comunicación clara de la solución, favoreciendo un entorno de trabajo ordenado, inclusivo y orientado al cumplimiento de los objetivos del equipo.
        </td>
        <td valign="top">AV1: El equipo consolidó un entorno de trabajo organizado mediante el uso eficiente de repositorios comunes, documentación estandarizada y herramientas ágiles. Esto permitió una correcta planificación y distribución de tareas, fomentando la inclusión técnica de todos los miembros y asegurando el cumplimiento íntegro y oportuno de las metas trazadas para el entregable.<br><br>TB1: El equipo consolidó un entorno de trabajo estructurado mediante el uso de GitFlow, repositorios centralizados en GitHub, documentación estandarizada y herramientas de integración continua. Esta organización permitió una adecuada planificación, distribución eficiente de tareas y participación equitativa de todos los miembros, garantizando el cumplimiento oportuno y completo de los entregables del Sprint 2.</td>
      </tr>
    </tbody>
  </table>
</div>
